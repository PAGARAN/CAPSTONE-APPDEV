    ...
    return Scaffold(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color.fromARGB(123, 0, 0, 0), // Semi-transparent background
                          borderRadius: BorderRadius.vertical(bottom: Radius.circular(15)), // Match the image border radius
                        ),
                        child: Center(
                          child: Padding(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(15),
                  border: Border.all(color: Colors.black, width: 2), // Stroke design
                ),
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Column(
              ...
              Row(
                children: [
                  Image.asset('Assets/images/search.png', height: 14, width: 14),
                  SizedBox(width: 8),
                  Text(
                    'Recent Diagnoses',
                    style: TextStyle(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          BottomNavigationBarItem(
            icon: Image.asset('Assets/images/ScanNavBar.png', height: 24, width: 24),
            label: 'Scan',
          ),
          BottomNavigationBarItem(
            icon: Image.asset('Assets/images/DiagnosIcon.png', height: 24, width: 24),
            label: 'Diagnoses',
          ),
        ],
      ),
